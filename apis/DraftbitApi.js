...
export const episodesGET = async (Constants, { limit }, handlers, timeout) => {
  const paramsDict = {};
  if (limit !== undefined) {
    paramsDict['_limit'] = renderParam(limit);
  }
  paramsDict['_sort'] = 'created_at_utc';
...
export const useEpisodesGET = (
  ...
  return useQuery(
    ['episodes', args],
    () => episodesGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const postsGET = async (Constants, { limit }, handlers, timeout) => {
  const paramsDict = {};
  if (limit !== undefined) {
    paramsDict['_limit'] = renderParam(limit);
  }
  paramsDict['_sort'] = 'created_at_utc';
  const url = `https://example-data.draftbit.com/posts${renderQueryString(
    paramsDict
  )}`;
  const controller = new AbortController();
  let timeoutObj;
...
export const usePostsGET = (
  ...
  return useQuery(
    ['posts', args],
    () => postsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const productsGET = async (Constants, { limit }, handlers, timeout) => {
  const paramsDict = {};
  if (limit !== undefined) {
    paramsDict['_limit'] = renderParam(limit);
  }
...
export const useProductsGET = (
  ...
  return useQuery(
    ...
    () => productsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const reviewsGET = async (Constants, { limit }, handlers, timeout) => {
  const paramsDict = {};
  if (limit !== undefined) {
    paramsDict['_limit'] = renderParam(limit);
  }
  paramsDict['_sort'] = 'date';
  const url = `https://example-data.draftbit.com/orders${renderQueryString(
    paramsDict
  )}`;
  const controller = new AbortController();
  let timeoutObj;
